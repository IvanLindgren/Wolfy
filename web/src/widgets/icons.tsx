...
/** Раскрытая книга со стрелкой назад: вспомнить уже прочитанный сюжет. */
export const RecapIcon = icon(
  <>
    <path d="M2.5 7c3.5-1.6 6.7-1.2 9.5 1.2 2.8-2.4 6-2.8 9.5-1.2v13c-3.5-1.5-6.7-1.1-9.5 1.3-2.8-2.4-6-2.8-9.5-1.3zM12 8.2v13.1" />
    <path d="m9.5 12.3-3 1.9 3 1.9M6.8 14.2h4" />
  </>,
)

...
export function DiscoveryScreen() {
  ...
  if (!account.data) return <div className={page.page}><WolfyCompanion mood="kind" title="Лента открывается после входа"><p className={page.muted}>Она запоминает ваш уровень и жанры, поэтому профиль должен принадлежать аккаунту. Книги и тренировки без входа уже работают.</p><Link to="/account"><Button variant="primary">Войти</Button></Link></WolfyCompanion></div>

...
kotlin {
    ...
    sourceSets {
        ...
        androidMain.dependencies {
            ...
            // EXIF: снимки из галереи хранят поворот в метаданных, и без них
            // обложка ляжет боком. Работает на всех поддерживаемых API,
            // в отличие от ImageDecoder, которому нужен 28-й.
